...
/**
 * Sticky floating chat CTA stack — bottom-right on every viewport. Renders a
 * WhatsApp button (tenant's storefront_whatsapp) and/or a Messenger button
 * (m.me deep link from GET /storefronts/{slug}/messenger-link); whichever the
...
/** Official WhatsApp glyph — lucide dropped brand icons, so inline SVG. */
