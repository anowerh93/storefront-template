      ...
      <main className="mx-auto max-w-[1100px] px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid lg:grid-cols-[minmax(0,1fr)_360px] gap-8 lg:gap-12 items-start">
          ...
          <div>
            ...
            {service.summary && <p className="mt-2 text-slate-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: service.summary }} />}
                ...
                <div className="divide-y divide-slate-200 rounded-2xl ring-1 ring-slate-200 overflow-hidden">
                  {service.faq.map((f, i) => (
                    <details key={i} className="group bg-white">
                      ...
                      <p className="px-5 pb-4 text-sm text-slate-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: f.a }} />
                    </details>
                  ))}
                </div>
              </div>
